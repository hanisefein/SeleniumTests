...
public class test_009_transavia_can_be_loaded {
    ...
    @Test
    public void transavia_can_be_loaded() {
...
//            System.out.println();
            ...
            driver.navigate().to("http://public.htxdev.com/en/?ref=trs");

            // WAIT FOR
            Utils.wait(4);

            // VERIFY DISPLAY AFFILIATE LOGO IS DISPLAYED
            Boolean actual1 = driver.findElement(By.xpath("//*[@id=\"toggleIcon\"]/div/a/span/img")).isDisplayed();
